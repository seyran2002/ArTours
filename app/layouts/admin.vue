...
const isLoginPage = computed(() => {
  ...
  return route.path === '/admin/login' || route.path === loginPath || route.path.endsWith('/admin/login')
})
...
<template>
  <div class="min-h-screen bg-zinc-50/80 text-zinc-950 flex flex-col relative overflow-hidden font-sans select-none">
    ...
    <main
      v-if="isLoginPage"
      class="flex-grow flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 z-10"
    >
      <!-- Back to site -->
