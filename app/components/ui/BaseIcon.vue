...
<template>
  <svg
    ...
    :class="[sizeClass, customClass, 'inline-block transition-colors duration-200']"
    :style="styleAttr"
    aria-hidden="true"
  >
    <!-- Home Icon -->
    ...
    <!-- Tours / Compass Icon -->
    <template v-else-if="name === 'tours'">
      <circle cx="12" cy="12" r="10" />
      <polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76" />
    </template>

    <!-- About Us / User / People Icon -->
    ...
    <template v-else-if="name === 'booking'">
      <path d="M2 9a3 3 0 0 1 0-6h16a3 3 0 0 1 0 6 2 2 0 0 0 0 4 3 3 0 0 1 0 6H2a3 3 0 0 1 0-6 2 2 0 0 0 0-4Z" />
      <path d="M9 3v18" stroke-dasharray="4" />
    </template>
    ...
    <template v-else-if="name === 'star'">
      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill="currentColor" stroke="currentColor" stroke-width="1" />
    </template>
